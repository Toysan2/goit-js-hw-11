...
document.getElementById("search-form").addEventListener("submit", async function(e) {
    ...
    try {
        isLoading = true;
        const data = await (0, _apiJs.fetchImages)(query);
        isLoading = false;
        if (data.hits.length === 0) {
            (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
            return;
        }
        if (data.totalHits === 1) (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${data.totalHits} image.`);
        else (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${data.totalHits} images.`);
...
window.addEventListener("scroll", async function() {
    ...
    if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 500 && !isLoading) try {
        isLoading = true;
        const data = await (0, _apiJs.fetchImages)(query);
        isLoading = false;
        renderImages(data.hits);
...
},{"notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./api.js":"9u7qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"kaxSc":[function() {},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequirea610")

...
})({"cXGp3":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "0687f5a6d6b93bc9";
...
},{}],"2MLSa":[function(require,module,exports) {
...
async function fetchImages(query) {
    try {
        ...
        if (page === 1) (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${response.data.totalHits} images.`);
        renderImages(response.data.hits);
        if (lightbox) lightbox.refresh();
        else lightbox = new (0, _simplelightboxDefault.default)(".gallery a", {
        });
        page++;
        isLoading = false;
    } catch (error) {
        ...
        (0, _notiflixDefault.default).Notify.failure("An error occurred. Please try again.");
    }
}
...
window.addEventListener("scroll", function() {
    ...
    if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 500 && !isLoading) fetchImages(query);
});

},{"axios":"jo6P5","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kaxSc":[function() {},{}]},["cXGp3","2MLSa"], "2MLSa", "parcelRequirea610")

//# sourceMappingURL=index.d6b93bc9.js.map
